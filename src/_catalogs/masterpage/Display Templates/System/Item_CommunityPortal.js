...
{
    pictureURL = $urlHtmlEncodeString(SP.Utilities.VersionUtility.getImageUrl("siteicon.png"));
}
...
AddPostRenderCallback(ctx, function() {ULSaAe:;
    EnsureScriptFunc("strings.js", "Strings", function() {ULSaAe:; EnsureScriptFunc("sp.datetimeutil.js", "SP.DateTimeUtil.SPRelativeDateTime", function() {ULSaAe:;
        ...
        var line3HTML = String.format($htmlEncode(membersString), "<span class='ms-communityPortalEmphasisText'>" + $htmlEncode(membersCount.value) + "</span>");
        var line3Title = String.format(membersString, $htmlEncode(membersCount.value));
...
,'                </a>'
,'                <span class="ms-communityPortalCalloutIcon"><img src="', $urlHtmlEncodeString(ellipsisURL) ,'" onclick="', showHoverPanelCallback ,'" /></span>'
);
if(!line2.isEmpty)
{
ms_outHtml.push(''
