...
,'            </div>'
        ...
        var hasYammerPostCapability = (!(window["OffSwitch"] == null || OffSwitch.IsActive("b9530760-4111-42c9-9af1-b7bbdfd33b9e")) &&
            !Srch.U.n(SP) &&
...
,'            </div>'
        ...
        else if (!Srch.U.isSPFSKU() && ctx.CurrentItem.csr_ShowFollowLink && !$isEmptyString(ctx.CurrentItem.Path) && window.IsSPSocialSwitchEnabled && IsSPSocialSwitchEnabled()){
            var isDoc = true;
...
if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fSearch\u002fItem_CommonHoverPanel_Actions.js", DisplayTemplate_de3aacf5af8644f8911004043096b6e2);
    ...
    if (!(window["OffSwitch"] == null || OffSwitch.IsActive("b9530760-4111-42c9-9af1-b7bbdfd33b9e")))
    {
