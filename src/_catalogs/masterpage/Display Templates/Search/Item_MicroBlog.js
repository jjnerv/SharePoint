...
,'                            <a clicktype="Result" id="', $htmlEncode(titleLinkId) ,'" href="', $urlHtmlEncodeString(threadLink) ,'" class="ms-srch-item-link" title="', $htmlEncode(ctx.CurrentItem.Title) ,'" onfocus="', showHoverPanelCallback ,'">'
...
,'                            <img class="ms-srchnav-quotationopenglyph" src="', $urlHtmlEncodeString(GetThemedImageUrl('searchresultui.png')) ,'" />'
,'                        </span>'
);
                    if (!$isEmptyString(ctx.CurrentItem.HitHighlightedSummary))
                    {
...
ms_outHtml.push(''
,'                        <a clicktype="Result" href="', $urlHtmlEncodeString(ctx.CurrentItem.AttachmentURI) ,'">'
,'                            <img src="', $urlHtmlEncodeString(pictureIconUrl) ,'" />'
,'                        </a>'
);
                    }
ms_outHtml.push(''
,'                        <span class="ms-srchnav-quotationcloseglyph-span">'
,'                            <img class="ms-srchnav-quotationcloseglyph" src="', $urlHtmlEncodeString(GetThemedImageUrl('searchresultui.png')) ,'" />'
,'                        </span>'
,'                    </div>'
);
                }
