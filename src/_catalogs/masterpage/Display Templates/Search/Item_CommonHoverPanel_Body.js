            ...
            {ULShXN:;
                ...
                {ULShXN:;
                    ...
                    {ULShXN:;
                        ...
                        var timeZoneOffset = Srch.ScriptApplicationManager.get_current().states["timeZoneOffsetInHours"];
                        var lastModifiedDate = ctx.CurrentItem.LastModifiedTime;
                        var now_utc = new Date(lastModifiedDate.getUTCFullYear(), lastModifiedDate.getUTCMonth(), lastModifiedDate.getUTCDate(), lastModifiedDate.getUTCHours(), lastModifiedDate.getUTCMinutes(), lastModifiedDate.getUTCSeconds());
                        now_utc.setTime(now_utc.getTime() + Math.floor(timeZoneOffset*60*60*1000));
                        var convertedDate = SP.DateTimeUtil.IntlDate.createFromJsLocalDate(now_utc, Srch.U.getCalendarType());
